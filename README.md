...
## Hardware Mapping & Resource Management:Due to limited I/O (4 LEDs), I implemented a specific signal mapping strategy:Pins 1, 2, 3: Lower 3 bits of the ALU result ($y[2:0]$).Pin 11: System Heartbeat (Clock verification).Buttons 88, 89: 2-bit Opcode selection.
